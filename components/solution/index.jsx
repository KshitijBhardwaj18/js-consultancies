...
import solution from "@/public/assets/solution.png";
import Image from "next/image";

const Solution = () => {
  return (
    <div className="solution container flex flex-col p-6  mb-20 gap-4 mx-auto ">
      <h1 className=" text-4xl font-bold text-center mt-10 mx-auto md:text-5xl md:text-left ">
      ...
      <div className="cards flex flex-col gap-3 mx-auto md:max-w-7xl md:flex-row md:gap-5 md:mx-auto">
        <div className="card p-5 mx-auto">
          <div className="image">
            <Image src={solution} alt="image" className="image rounded-3xl" />
          </div>
