...
import banner2 from "@/public/assets/scene1.jpg";
...
const Quality = () => (
  <>
    ...
    <div className="strategic flex flex-col gap-9">
      <div className="p-10">
        <h1 className="heading font-sans text-6xl p-30">Quality Management</h1>
        ...
        <span className="sub font-sans2 text-xl ">Set Up and Introduction </span>
        ...
        <span className="sub font-sans2 text-xl">Customisable Quality Standards</span>
        <div className="font-sans text-xl">
        ...
        <div className="para font-sans text-xl pt-3">
          ...
          experience from various industries to elevate your existing QM system
          to a new level of efficiency and transparency. We understand that
          every company is unique. Therefore, we offer a flexible approach
          tailored specifically to your particular needs and goals. Whether you
          want a complete redesign of your QM system, an optimization of
          specific areas, or a revision of individual processes, we are ready to
          provide you with a custom solution that supports your company on its
          path to excellence. With us by your side, you can be confident that
          your QM system not only meets the standards but also exceeds them.
          Increase your productivity, improve your workflows, and let your
          business operate more efficiently than ever before with our support.
        </div>

        <h3 className="sub-heading  font-sans2 text-3xl pt-5 ">Remote Audit</h3>
        ...
        <div className="para font-sans text-xl pt-3">
          ...
          quality, we offer thorough internal audits in compliance with ISO
          19011. Our expertise spans a range of sectors, including mechanical
          ...
          quality standards. Let us help you make compliance one of your
        ...
        <div className="para font-sans text-xl pt-3">
          ...
          audit services. Our specialists bring an unmatched mix of expertise
          and experience to thoroughly examine your business model and uncover
          ...
          experts scrutinize every detail of your processes and systems to
          ensure they are optimized and running efficiently. Through our
          comprehensive analysis, we can point out potential risks before they
          become real threats. We offer you concrete solutions tailored to your
          business to minimize these risks while simultaneously improving your
          business processes. Our goal is to help you embark on a consistent
          path of continuous improvement. Invest in our internal audit services
          and find out how you can take your business performance to the next
          level.
        </div>
        ...
        <div className="para font-sans text-xl pt-3">
          ...
          knowledge and years of experience in various industries and are at
          your side to ensure and optimize the quality of your products,
          processes, and services. Our main concern as your External QMR is the
          constant improvement and maintenance of quality at the highest level.
          We use proven methods and rely on strategies individually tailored to
          your company. We support you in developing and implementing quality
          management systems and processes that meet your specific requirements.
          We ensure compliance with all relevant standards and guidelines and
          make sure that you are optimally prepared for external audits. As your
          External QMR, we also take over the training and education of your
          employees in terms of quality awareness and dealing with QM systems.
          Our goal is to anchor a culture of quality in your company that leads
          to sustainable growth and success. Invest in our External Quality
